...
func testSweepGKEHubFeature(region string) error {
	...
	listTemplate := strings.Split("https://gkehub.googleapis.com/v1alpha1/projects/{{project}}/locations/global/features", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://gkehub.googleapis.com/v1alpha1/projects/{{project}}/locations/global/features/{{feature_id}}"
